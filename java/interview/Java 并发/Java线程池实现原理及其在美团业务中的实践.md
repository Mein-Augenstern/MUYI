...
![meituan-thread-pool-3]()

其生命周期转换如下入所示：

![meituan-thread-pool-4]()
...
![meituan-thread-pool-6]()

使用不同的队列可以实现不一样的任务存取策略。在这里，我们可以再介绍下阻塞队列的成员：

![meituan-thread-pool-7]()
...
![meituan-thread-pool-23]()

**参数动态化**

JDK原生线程池ThreadPoolExecutor提供了如下几个public的setter方法，如下图所示：

![meituan-thread-pool-24]()
